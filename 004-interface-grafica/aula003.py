...
def other_slot(status_bar):
  status_bar.showMessage('O slot está sendo chamado denovo.')
...
secondAction = firstMenu.addAction('CONTATO')
secondAction.setCheckable(True)
secondAction.toggled.connect(
  lambda: other_slot(status_bar)
)
